...
<CardGroup cols={2}>
  <Card title="GET /api/servers" href="#获取所有服务器">
    获取所有 MCP 服务器的列表
  </Card>
  <Card title="POST /api/servers" href="#创建一个新服务器">
    创建一个新的 MCP 服务器
  </Card>
  <Card title="PUT /api/servers/:name" href="#更新一个服务器">
    更新现有的 MCP 服务器
  </Card>
  <Card title="DELETE /api/servers/:name" href="#删除一个服务器">
    删除一个 MCP 服务器
  </Card>
  <Card title="POST /api/servers/:name/toggle" href="#切换一个服务器">
    切换服务器的启用状态
  </Card>
  <Card title="POST /api/servers/:serverName/tools/:toolName/toggle" href="#切换一个工具">
    切换工具的启用状态
  </Card>
  <Card title="PUT /api/servers/:serverName/tools/:toolName/description" href="#更新工具描述">
    更新工具的描述
  </Card>
</CardGroup>
