...
<CardGroup cols={2}>
  <Card title="POST /api/auth/login" href="#登录">
    登录以获取 JWT 令牌
  </Card>
  <Card title="POST /api/auth/register" href="#注册">
    注册一个新用户
  </Card>
  <Card title="GET /api/auth/user" href="#获取当前用户">
    获取当前已验证的用户
  </Card>
  <Card title="POST /api/auth/change-password" href="#更改密码">
    更改当前用户的密码
  </Card>
</CardGroup>
