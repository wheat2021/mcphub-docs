...
<CardGroup cols={2}>
  <Card title="PUT /api/system-config" href="#更新系统配置">
    更新主系统配置
  </Card>
  <Card title="GET /api/settings" href="#获取所有设置">
    获取所有系统设置，包括服务器和群组
  </Card>
  <Card title="GET /config" href="#获取运行时配置">
    获取前端的公共运行时配置
  </Card>
  <Card title="GET /public-config" href="#获取公共配置">
    获取公共配置以检查是否跳过身份验证
  </Card>
</CardGroup>
